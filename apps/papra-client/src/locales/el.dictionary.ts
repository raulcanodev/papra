...
export const translations: Partial<TranslationsDictionary> = {
  ...
  'user.settings.two-factor.setup-dialog.description': 'Σαρώστε τον QR κώδικα και εισαγάγετε τον κωδικό επιβεβαίωσης.',
  'user.settings.two-factor.setup-dialog.qr-loading': 'Φόρτωση QR κώδικα...',
  ...
  'user.settings.two-factor.setup-dialog.code.label': 'Κωδικός επιβεβαίωσης',
  'user.settings.two-factor.setup-dialog.code.placeholder': 'Εισαγάγετε 6-ψήφιο κωδικό',
  'user.settings.two-factor.setup-dialog.code.required': 'Παρακαλώ εισαγάγετε τον κωδικό επιβεβαίωσης',
  ...
  'user.settings.two-factor.backup-codes-dialog.warning': 'Κάθε κωδικός μπορεί να χρησιμοποιηθεί μόνο μία φορά.',
  ...
  'user.settings.two-factor.backup-codes-dialog.copied': 'Αντιγράφηκαν στο πρόχειρο',
  ...
  'user.settings.two-factor.verification-failed': 'Η επιβεβαίωση απέτυχε. Ελέγξτε τον κωδικό και ξαναπροσπαθήστε.',
  ...
  'documents.list.search.no-results': 'Δεν βρέθηκαν έγγραφα που να ταιριάζουν',
  ...
  'documents.actions.download': 'Λήψη',
  'documents.actions.open-in-new-tab': 'Άνοιγμα σε νέα καρτέλα',
  ...
  'api-errors.auth.invalid_origin': 'Μη έγκυρη προέλευση εφαρμογής.',
  ...
  'subscriptions.upgrade-dialog.current-plan': 'Τρέχον πλάνο',
  'subscriptions.upgrade-dialog.recommended': 'Προτείνεται',
