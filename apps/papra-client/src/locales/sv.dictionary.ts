...
export const translations: Partial<TranslationsDictionary> = {
  ...
  'user.settings.two-factor.setup-dialog.description': 'Skanna denna QR-kod med din autentiseringsapp och ange sedan verifieringskoden.',
  'user.settings.two-factor.setup-dialog.qr-loading': 'Laddar QR-kod...',
  ...
  'user.settings.two-factor.setup-dialog.code.label': 'Verifieringskod',
  'user.settings.two-factor.setup-dialog.code.placeholder': 'Ange sexsiffrig kod',
  'user.settings.two-factor.setup-dialog.code.required': 'Ange verifieringskoden',
  ...
  'user.settings.two-factor.backup-codes-dialog.warning': 'Varje kod kan endast användas en gång.',
  ...
  'user.settings.two-factor.backup-codes-dialog.copied': 'Koder kopierade till urklipp',
  ...
  'user.settings.two-factor.verification-failed': 'Verifiering misslyckades. Kontrollera din kod och försök igen.',
  ...
  'documents.list.search.no-results': 'Inga dokument hittades som matchar denna sökning',
  ...
  'documents.actions.download': 'Ladda ner',
  'documents.actions.open-in-new-tab': 'Öppna i ny tabb',
  ...
  'tagging-rules.form.submit': 'Skapa regel',
  ...
  'api-keys.list.card.last-used': 'Senast använd',
  'api-keys.list.card.never': 'Aldrig',
  ...
  'subscriptions.upgrade-dialog.current-plan': 'Nuvarande abonnemang',
  'subscriptions.upgrade-dialog.recommended': 'Rekommenderad',
